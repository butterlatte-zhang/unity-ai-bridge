...
> **AI-native project** — Just tell your AI assistant: *"Help me install Unity AI Bridge"* and point it to this repo. The [setup guide](docs/SETUP.md) is written for AI assistants to follow. You don't need to read or execute any commands yourself.
